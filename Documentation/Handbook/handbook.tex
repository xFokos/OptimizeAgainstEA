...
small circle around it (as contour lines or a heat map), giving you partial
...
contours}{Peak Finder: probing a hidden surface. Contours are only revealed
near your probes.}
...
\begin{itemize}
  ...
  \item \textbf{Visualization:} switch between \uielem{Contour} and
        \uielem{Heatmap} display of the revealed areas.
...
\begin{itemize}
  ...
  \item The EA maintains a \textbf{population} of candidate points. It wins
        when a sufficient fraction of its population (default 10\%)
...
settings panel exposes the following parameters (defaults in parentheses):
...
\uielem{WIN}). Use the playback controls to step forward/backward or let it
autoplay. A fitness chart tracks the population's best value across
generations.
