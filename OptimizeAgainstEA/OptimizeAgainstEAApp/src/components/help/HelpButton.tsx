...
export function HelpButton({ topic, label = 'How does it work?', className = 'btn btn--outline help-button', onTakeTour }: HelpButtonProps) {
    ...
    return (
        <>
            ...
            {open && <HelpModal topic={topic} onClose={() => setOpen(false)} onTakeTour={onTakeTour} />}
        </>
    );
}
