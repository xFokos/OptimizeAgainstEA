...
import { ProbeMarker } from './ProbeMarker.tsx';
    ...
    <div className="play-mode">
      ...
      <div className="play-layout">
                ...
                {[...probes].reverse().map((p, i) => {
                  ...
                  return (
                    <div key={i} className={`probe-row ${isBest ? 'probe-row--best' : ''}`}>
                      ...
                      <div
                        className="probe-row__swatch"
                        style={{ background: swatchColor(p.value) }}
                      />
        ...
        <div className="play-map-wrap" style={{ position: 'relative' }}>
          <GameMap
            onMapClick={status !== 'won' ? probe : undefined}
          >
            {probes.map((p, i) => (
              <ProbeMarker
                key={i}
